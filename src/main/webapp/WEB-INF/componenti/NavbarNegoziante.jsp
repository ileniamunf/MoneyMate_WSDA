<nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top" >
  <div class="container-fluid">
    ...
    <div class="dropdown" role="search" style="position:absolute; right:1.5em">
      ...
      <ul class="dropdown-menu" style="left: -155px; top:65px; padding-bottom: 0px">
        <li><a class="dropdown-item" href="AddebitaRicaricaCartaServlet">Addebita/Ricarica Carta</a></li>
